<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MoveScheduling.aspx.cs" Inherits="Lab3.MoveScheduling" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Table ID="Table1" runat="server">
        ...
        <asp:TableRow>
            <asp:TableCell>
                <asp:GridView ID="grdNotification" runat="server" AutoGenerateColumns="false" DataKeyNames="MoveNotificationID" CssClass="table">
                    <Columns>
