        ...
        <asp:Table ID="detailTable" runat="server">
            ...
            <asp:TableRow Height="100px">
                <asp:TableCell ColumnSpan="3">
                    <asp:Label ID="lblCustDetail" runat="server" Text="Customer Search" Font-Bold="true"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
        ...
        <asp:Table ID="Table1" runat="server" HorizontalAlign="Left">
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Left" ColumnSpan="2">
                    <asp:Label ID="lblCustomers" runat="server" Text="Customer Results:"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Left" ColumnSpan="2">
                    <asp:Label ID="lblTickets" runat="server" Text="Tickets for selected customer:"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Left">
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Left" ColumnSpan="2">
                    <asp:Label ID="lblNotes" runat="server" Text="Selected ticket's notes:"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Left">
            ...
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Left" ColumnSpan="2">
                    <asp:Label ID="lblHistory" runat="server" Text="Selected ticket's history:"></asp:Label>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell HorizontalAlign="Left">
